                ...
                ">
                    <thead>
                        <tr style="background-color: #FB6340; color: black;">
                            <th rowspan="1" colspan="1">Nama Beasiswa</th>
                            <th rowspan="1" colspan="1">Asal Beasiswa</th>
                            <th rowspan="1" colspan="1">NRP</th>
                            ...
                            <th  rowspan="1" colspan="1">Periode Beasiswa</th>
                            <th  rowspan="1" colspan="1">Status</th> 
                        </tr>
                    </thead>
                    <tbody>
                        <tr style="color: black; background-color:#FAF7FF;">
                            <td>Kosong</td>
                            <td>Kosong</td>
                            <td>Kosong</td>
                            <td>Kosong</td>
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Universitas KristenY</h5>
