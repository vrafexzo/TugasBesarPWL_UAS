...
<main class="main-content position-relative border-radius-lg" style="min-height: 100vh;">
    ...
    <div class="container" style="display: flex; flex-direction: column; align-items: center;">
        ...
        ">
            ...
            <div class="card-body">
                <form action="{{ route('periode_beasiswa.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="id_beasiswa" name="id_beasiswa" placeholder="Masukkan Jenis Beasiswa" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi Beasiswa"></textarea>
                    </div> 
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('periode_beasiswa.edit', ['id_periode' => $beasiswa->id_periode, 'id_beasiswa' => $beasiswa->id_beasiswa]) }}" title="Edit Beasiswa">
                                    <button class="btn btn-info" style="width: 60px; display: inline-flex; align-items: center; justify-content: center;">Edit</button>
                                </a>
                        
                                <form action="{{ route('periode_beasiswa.destroy', ['id_periode' => $beasiswa->id_periode, 'id_beasiswa' => $beasiswa->id_beasiswa]) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
